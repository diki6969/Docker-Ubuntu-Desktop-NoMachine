...
./ngrok authtoken "2Ss3NhinGdFjxDRuWqbDMsUXg13_63H8aEUtVVX5w8UHWdpbE"
...
seq 1 999999999999999999 | while read i; do echo -en "\r Running .     $i s /999999999999999999 s";sleep 0.1;echo -en "\r Running ..    $i s /999999999999999999 s";sleep 0.1;echo -en "\r Running ...   $i s /999999999999999999 s";sleep 0.1;echo -en "\r Running ....  $i s /999999999999999999 s";sleep 0.1;echo -en "\r Running ..... $i s /999999999999999999 s";sleep 0.1;echo -en "\r Running     . $i s /999999999999999999 s";sleep 0.1;echo -en "\r Running  .... $i s /999999999999999999 s";sleep 0.1;echo -en "\r Running   ... $i s /999999999999999999 s";sleep 0.1;echo -en "\r Running    .. $i s /999999999999999999 s";sleep 0.1;echo -en "\r Running     . $i s /999999999999999999 s";sleep 0.1; done
